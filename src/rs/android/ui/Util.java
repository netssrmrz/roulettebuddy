...
public class Util
{
  ...
  public static void SetWidgets(android.app.Activity activity, java.lang.Class<? extends Object> ids_class) 
  {
    ...
    //android.util.Log.d("Set_Button_Colour()", "entry");
		if (colour != null)
		{
	...
	public static void Remove_Button_Colour(android.widget.Button button)
	{
    //android.util.Log.d("Remove_Button_Colour()", "entry");
    //if (button instanceof rs.roulettebudddy.Bet_Button)
      //android.util.Log.d("Remove_Button_Colour()", ((rs.roulettebudddy.Bet_Button)button).To_String());
		//button.getBackground().setColorFilter(null);
    //button.getBackground().clearColorFilter();
    Set_Button_Colour(button, 0x00000000);
	}
}
