...
extends android.graphics.drawable.Drawable
{
  public android.graphics.Paint top_paint;
	...
	public static void Add_Border_Top(android.view.View v, int colour, float width,
	  float top_padding)
	{
		Add_Border(v, width, 0, 0, 0, top_padding, 0, 0, 0, colour, null);
	}
	
	public static void Add_Border_Bottom(android.view.View v, int colour, float width,
	  float margin)
	{
		Add_Border(v, 0, 0, width, 0, 0, 0, margin, 0, colour, null);
	}
